...
menu_list = [ 'File', 'Tool', 'View', 'help']
menu = [('New', 'Open', 'Save', 'Save As', 'Print', 'Import', 'Export', 'Options'), ('Copy', 'Cut', 'Paste', 'Search' ), ('empty'), ('empty')  ]
menu_build = [x for item in menu_list]
print(menu_build, "\n")
